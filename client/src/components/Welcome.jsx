...
const Welcome = () => {
    ...
    return (
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row  xl:w-2/3 flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start items-start flex-col mf:mr-10 ">
                            <h1 className="text-5xl sm:text-5xl text-white text-gradient py-1 ">
                                Send Crypto <br /> Accross the world
                            </h1>
                            <p className="text-left mt-5 font-light text-white md:w-9/12 w-11/12 text-base">
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    {isLoading ? (
                        ...
                        className="text-white w-full mt-2 border-[1px] p-2 border-[#3d4f7c] rounded-full cursor-pointer hover:bg-[#3d4f7f]">
                            Send Now
                    </button>)}
                    </div>
                    </div>
